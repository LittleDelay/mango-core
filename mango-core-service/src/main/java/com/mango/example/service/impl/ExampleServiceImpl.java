...
public class ExampleServiceImpl {
     ...
     * @return 示例列表
     */
    public PageListResponse<ExamplePageBo> listExamplePage(QueryExamplePageParam queryExamplePageParam) {
        final Page<ExamplePageBo> examples = PageHelper.startPage(
                queryExamplePageParam.getPageNumber(), queryExamplePageParam.getPageSize())
                .doSelectPage(() -> exampleMapper.listExamplePage(queryExamplePageParam));
        return new PageListResponse<>(examples);
    }
